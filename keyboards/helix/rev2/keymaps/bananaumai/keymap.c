...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |      |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   *  |   7  |   8  |   9  |   =  |             | Del  | Space| Bksp | Enter| Esc  |      |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |   .  |   4  |   5  |   6  |   -  |             |   %  |   -  |   =  |   +  |  /   |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |   0  |   1  |   2  |   3  |   +  |      |      |   /  | Enter|   [  |   ]  |      |      |
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_EQL,  KC_7,    KC_8,    KC_9,    KC_EQL,                    KC_DEL,  KC_SPC,  KC_BSPC, KC_ENT,  KC_ESC,  _______, \
      _______, KC_DOT,  KC_4,    KC_5,    KC_6,    KC_MINS,                   KC_PERC, KC_MINS, KC_EQL,  KC_PLUS, KC_SLSH, _______, \
