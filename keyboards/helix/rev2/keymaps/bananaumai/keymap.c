...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_0,    KC_1,    KC_2,    KC_3,    KC_EQL,  _______, _______, KC_LBRC, KC_RBRC, KC_PGDN, KC_PGUP, _______, _______, \
  ...
  [_RAISE] = LAYOUT( \
      _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
      _______, _______, _______, KC_ESC,  _______, _______,                   _______, _______, _______, KC_ENT,  _______, _______, \
      _______, _______, KC_SPC,  KC_DEL,  _______, _______,                   KC_BSPC, KC_ENT,  _______, _______, _______, _______, \
      _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______, KC_MINS, KC_EQL,  _______, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
      ),
