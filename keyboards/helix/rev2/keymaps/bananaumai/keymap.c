...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT( \
      ...
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
      _______, _______, KC_SPC,  KC_DEL,  _______, _______,                   KC_BSPC, KC_MINS, KC_EQL,  _______, _______, _______, \
      _______, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
      ),
