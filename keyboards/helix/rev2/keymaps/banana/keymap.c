...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Qwerty
   * ,-----------------------------------------.             ,-----------------------------------------.
   * | Esc  |   `  |   \  |   -  |Lower |Enter |             |Enter |Raise |   +  |   [  |   ]  | Del  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|PageDn|PageUp| Alt  | GUI  |Space |Raise |LOWER |Space | GUI  |   Up | Down | Left |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      KC_ESC,  KC_GRV,  KC_BSLS, KC_MINS, LOWER,   KC_ENT,                    KC_ENT,  RAISE,   KC_PLUS, KC_LBRC, KC_RBRC, KC_DEL,   \
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,  \
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LPRN, KC_RPRN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT , \
      ADJUST,  KC_PGUP, KC_PGDN, KC_LALT, KC_LGUI, KC_SPC,  RAISE,   LOWER,  KC_SPC,  KC_LGUI, KC_UP,   KC_DOWN, KC_LEFT,   KC_RGHT   \
      ),
   ...
   * |      |   .  |   4  |   5  |   6  |   -  |             |  F6  |   -  |   =  |   [  |   ]  |  \   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |   0  |   1  |   2  |   3  |   +  |      |      |  F12 |      |      |PageDn|PageUp|      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_RAISE] = LAYOUT( \
      _______, _______, KC_7,    KC_8,    KC_P,    KC_SLSH,                   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
      _______, _______, KC_7,    KC_8,    KC_9,    KC_ASTR,                   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, \
      _______, KC_DOT,  KC_4,    KC_5,    KC_6,    KC_MINS,                   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
      _______, KC_0,    KC_1,    KC_2,    KC_3,    KC_PLUS, _______, _______, KC_F12,  _______, _______, KC_PGDN, KC_PGUP, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
